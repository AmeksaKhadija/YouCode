            ...
            <div class="h-100">
                ...
                <ul class="sidebar_nav">
                    <li class="sidebar_item">
                        <a href="users.php" class="sidebar_link"> <img src="img/agents.svg" alt="icon">Utilisateurs</a>
                    </li>
                    <li class="sidebar_item">
                ...
                <table class="agent table align-middle bg-white">
                    ...
                    <tbody>
                        ...
                        <tr class="freelancer">
                            ...
                            <td>
                            <p class="fw-bold mb-1 f_name"><?php echo $user['firstname'];?></p> 
                            </td>
                            <td>
                            <p class="fw-bold mb-1 f_name"><?php echo $user['lastname'];?></p> 
                            </td>
                            <td class="f_position">
                            <p class="fw-bold mb-1 f_name"><?php echo $user['role_name'];?></p> 
                            </td>
                            <td>
                                <img class="delet_user" src="img/user-x.svg" alt="">
                                <a href="edit.php?id=<?php echo $user['id_user'];?>"><img class="ms-2" src="img/edit.svg" alt=""></a>
                            </td>
                        </tr>
                        <?php
                        }
